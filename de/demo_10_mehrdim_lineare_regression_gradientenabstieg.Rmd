...
GradE_MLR <- function (pA,px_D,py_D) {
    ...
    for (i in 1:cols4y) {
      ...
      a <- pA[i, ]
      y1_D <- py_D[ ,i]
      grad <- grad + GradE_LR(a,px_D,y1_D)
     }
...
* [[KnitR/Vorlagen|Vorlagen in KnitR]]
* [[Wiki2Reveal]]
* [[Mehrdimensionale lineare Regression/Zerlegung|Zerlegung in Komponentenfunktionen]]
* [[Mehrdimensionale_lineare_Regression/Gesamtfehler_aller_Fehlerfunktionen#Aggregierter_Gesamtfehler_der_Komponentenfunktionen|Gesamtfehler der Komponentenfunktionen]]
