...
`output: powerpoint_document`, wenn Sie eine Präsentation erstellen wollen.
...
fuzzy_indicator <- function(pf1,pgrenze,pvalue0,pvalue1) {
  ...
  ### Rückgabewert ist das komponentenweise 
...
### 10 zufaellige Werte in uniformer Verteilung auf dem Intervall [0,1] erzeugen
f1 <- runif(10)
f2 <- runif(10)
f3 <- runif(10)
