...
learnSVM <- function (pVec4Norm,pVec4Supp, px_D, py_D, palpha=1, pmaxiteration=10, pevalcount=15,echolevel=2)  {
  ...
  print(paste("max interation=",pmax_iteration," evalcount=",pevalcount,sep="",collapse=""))
