...
auswertung_klausur <- function(pTitle,pStudentData) {
  ### Anzahl der Uebungen aus pStudentData ermitteln
  anzahl <- nrow(pStudentData)
  out4ret <- ""
...
uebung_erstellen <- function(pTitle,pData4Student) {
   uebblatt <- paste("\n### ",pTitle,"\nÜbungsblatt für ",pData4Student$name,"\n",sep="")
...
auswert <- auswertung_klausur(titel4ueb,studentdata)
