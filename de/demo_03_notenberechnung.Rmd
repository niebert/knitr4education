...
```{r punktesummen}
## Oben wurden die Spalten  `aufgabe1`, `aufgabe2`, `aufgabe3` aus der Tabelle data.csv  
## den Vektoren `a1`, `a2`, `a3` zugeordnet.

## Nun wurde vektoriell Punktesumme berechnet
summe <- a1 + a2 + a3

### in dem Dataframe `studentdata` wird nun die Spalte "summe" ergänzt und mit dem Vektor `summe` definiert
...
```{r}
maxpunkte <- 52 ## erste Zeile MAX enthält die maximal erreichbaren Punkte
bestgrenze <- 22  ## Bestehensgrenze ist 50% der Gesamtpunktzahl
