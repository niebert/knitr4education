...
## Nun kann man vektorielle Addition durchführen und die Punktesumme berechnen.
summe <- a1 + a2 + a3

## Die Punktesumme wird nun auch wieder `studentdata` zugewiesen.
studentdata$summe <- summe
## Ab dieser Codezeile hat `studentdata`  eine weitere Spalte.
```
