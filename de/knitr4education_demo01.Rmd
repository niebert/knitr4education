...
## Einleitung
Das ist ein R Markdown-Dokument. Markdown ist eine einfache Formatierungs-Syntax für die Autorisierung von HTML-, PDF- und MS Word-Dokumenten. Weitere Details zur Verwendung von R Markdown siehe <http://rmarkdown.rstudio.com>.

Wenn Sie auf die Schaltfläche **Knit*** klicken, wird ein Dokument generiert, das sowohl Inhalte als auch die Ausgabe von eingebetteten R-Code-Kissen innerhalb des Dokuments beinhaltet. Sie können einen R-Code so einbetten:
...
### Normalverteilung - Latex-Notartion der Dichtefunktion
$$
