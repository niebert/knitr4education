...
## Linearer Zusammenhang des Resultats der Einzelaufgaben mit der Punktesumme.
```{r}
lm(summe~a1+a2+a3)
```
...
newcol_names <- paste("fuzzy",3:5,sep="")
# Add new columns using a for loop
for (i in seq_along(col_names)) {
  df[, newcol_names[i]] <- df$A * i * 10  # You can replace this with your own calculation
}
