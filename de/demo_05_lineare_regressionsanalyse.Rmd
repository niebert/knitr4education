...
* Betrachten Sie den Begriff der [[w:de:Assoziation|Assoziation]], [Assoziative Netze](https://de.wikiversity.org/wiki/assoziative_Netze) und die [Hebbsche Lernregel](https://de.wikiversity.org/wiki/Maschinelles_Lernen/Hebbsche:Lernregel), mit der man die Koaktivität von Nervenzellen in der Ein- und Ausgabeschicht [mathematisch modellieren](https://de.wikiversity.org/wiki/Kurs:Mathematische_Modellbildung) kann.
